...
those who missed games due to personal reasons
'''
start = perf_counter()
...
urlEnd = "SearchResults.php?Player=&Team=&BeginDate=1999-10-28&EndDate=2019-10-01&PersonalChkBx=yes&submit=Search"
url = urlStart + urlEnd
...
misses = open('missedGamesPersonalMisses.txt', 'w')
...
df.to_csv('missedGamesPersonal.csv', mode='w', header = True, index = False)
