...
those who moved in and out of the minor league system
'''
start = perf_counter()
...
urlEnd = "SearchResults.php?Player=&Team=&BeginDate=1999-10-28&EndDate=2019-10-01&MinorsChkBx=yes&submit=Search"
url = urlStart + urlEnd
...
misses = open('minorLeagueMisses.txt', 'w')
...
df.to_csv('minorLeague.csv', mode='w', header = True, index = False)
