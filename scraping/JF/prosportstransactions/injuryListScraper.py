...
those who moved in and out of the injury list
'''
start = perf_counter()
...
urlEnd = "SearchResults.php?Player=&Team=&BeginDate=1999-10-28&EndDate=2019-10-01&DLChkBx=yes&submit=Search"
url = urlStart + urlEnd
...
misses = open('injuryListMisses.txt', 'w')
...
df.to_csv('injuryList.csv', mode='w', header = True, index = False)
