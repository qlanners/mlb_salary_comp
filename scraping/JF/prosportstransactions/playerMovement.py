...
urlEnd = "SearchResults.php?Player=&Team=&BeginDate=1999-10-28&EndDate=2019-10-01&PlayerMovementChkBx=yes&submit=Search"
url = urlStart + urlEnd
...
misses = open('playerMovementMisses_2.txt', 'w')
...
df.to_csv('playerMovement_2.csv', mode='w', header = True, index = False)
