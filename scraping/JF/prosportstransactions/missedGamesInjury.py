...
those who missed games due to injury
'''
start = perf_counter()
...
urlEnd = "SearchResults.php?Player=&Team=&BeginDate=1999-10-28&EndDate=2019-10-01&InjuriesChkBx=yes&submit=Search"
url = urlStart + urlEnd
...
misses = open('missedGamesInjuryMisses.txt', 'w')
...
df.to_csv('missedGamesInjury.csv', mode='w', header = True, index = False)
